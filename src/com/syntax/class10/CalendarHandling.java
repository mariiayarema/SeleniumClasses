...
public class CalendarHandling {
    public static void main(String[] args) {
        ...
        List<WebElement> cellsDepart = driver.findElements(By.xpath("//tbody[@class='dl-datepicker-tbody-0']/tr/td"));
        for (WebElement departDate : cellsDepart) {
        ...
        List<WebElement> rDate = driver.findElements(By.xpath("//tbody[@class='dl-datepicker-tbody-1']/tr/td"));
